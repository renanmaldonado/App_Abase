...
$( document ).ready(function() {
    function init_template(){//Class is vital to run AJAX Pages
        ...
        //Top Menu 
        $('.show-navigation, .close-menu').click(function(){
        ...
        $('.show-navigation').click(function(){
            ...
            //    $('.menu-top').delay(0).animate({
            //        scrollTop: $('.show-submenu , .scroll-here').offset().top - 104
            //    }, 250);
            //}
            //setTimeout(scroll_to_menu, 250);
        });
